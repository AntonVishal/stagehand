...
description: "Connect Antigravity CLI, Claude Code, Codex, CrewAI, Deep Agents, Eve, Mastra, fx, Pi, or the Vercel AI SDK to a persistent Stagehand browser."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Antigravity CLI" icon="/images/integrations/antigravity.svg" href="/v4/integrations/antigravity">
    Give an Antigravity CLI agent persistent Stagehand browser tools over MCP/stdio.
  </Card>
...
The Antigravity CLI, Claude Code, Codex, CrewAI, Mastra, fx, Vercel AI SDK, and local Deep Agents examples keep one MCP client session open so the stdio server and browser stay alive. Eve, Pi, and Managed Deep Agents bind equivalent tools in-process.
